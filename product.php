      ...
      if ($result->num_rows > 0) {
        while ($row = $result->fetch_assoc()) {
          ...
          if($orderResult->num_rows){
            ...
            echo "<p>Are you sure you want to deliver the following product?</p>";
            echo "<p><strong>Product Name:</strong> ".$r['product_name']."</p>";
            echo "<p><strong>Product ID:</strong> ".$r['product_id']."</p>";
            echo "<p><strong>Price:</strong> ".$r['price']."</p>";
            echo "<p><strong>User Email:</strong> ".$r['user_email']."</p>";
            echo "<p><strong>User Contact:</strong> ".$r['user_contact']."</p>";
            echo "<p><strong>User Address:</strong> ".$r['user_address']."</p>";
            echo "<p><strong>User Name:</strong> ".$r['user_name']."</p>";
            echo "<p><strong>Payment Status:</strong> ".$r['payment_status']."</p>";
            echo "</div>";
